...
import (
	...
	prom "github.com/nordicenergy/nordicenergy-core/api/service/prometheus"
...
var (
	...
	// 10 ExpnetntialBuckets are in the unit of millisecond:
	...
	consensusFinalityHistogram = prometheus.NewHistogram(
		prometheus.HistogramOpts{
			...
			Buckets:   prometheus.ExpnetntialBuckets(800, 1.25, 10),
		},
	)
