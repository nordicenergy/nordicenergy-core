...
import (
	...
	libbls "github.com/nordicenergy/bls/ffi/go/bls"
...
func (consensus *Consensus) onViewChangeSanityCheck(recvMsg *FBFTMessage) bool {
	// TODO: if difference is only net, new leader can still propose the same committed block to avoid another view change
