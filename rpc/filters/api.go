...
// enters the transaction pool and was signed from net of the transactions this nodes manages.
	...
	go func() {
		...
		for {
			...
			case hashes := <-txHashes:
				// To keep the original behaviour, send a single tx hash in net notification.
				// TODO(dm) Send a batch of tx hashes in net notification
