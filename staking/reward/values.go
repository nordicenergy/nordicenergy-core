...
var (
	...
	// TotalInitialTokens is the total amount of tokens (in net) at block 0 of the network.
...
//
// Data Source: https://github.com/nordicenergy/jupyter
//
...
// GetTotalTokens in the network for all shards in net.
...
// GetTotalPreStakingTokens returns the total amount of tokens (in net) in the
