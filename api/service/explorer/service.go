...
var (
	// InaccessibleAddresses are a list of known eth addresses that cannot spend net tokens.
	InaccessibleAddresses = []ethCommon.Address{
		// net10000000000000000000000000000dead5shlag
...
// getTotalInaccessibleTokens in net at the latest header.
