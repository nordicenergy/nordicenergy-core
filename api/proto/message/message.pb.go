...
//
// The request field will be either net of the structure corresponding to the MessageType type.
type Message struct {
	...
	Request isMessage_Request `protobuf_netof:"request"`
}
...
type Message_Staking struct {
	// Deprecated: Do not use.
	Staking *StakingRequest `protobuf:"bytes,4,opt,name=staking,proto3,netof"`
}

type Message_Consensus struct {
	Consensus *ConsensusRequest `protobuf:"bytes,5,opt,name=consensus,proto3,netof"`
}

type Message_Drand struct {
	// Deprecated: Do not use.
	Drand *DrandRequest `protobuf:"bytes,6,opt,name=drand,proto3,netof"`
}

type Message_Viewchange struct {
	Viewchange *ViewChangeRequest `protobuf:"bytes,7,opt,name=viewchange,proto3,netof"`
}
...
type Message_LotteryRequest struct {
	...
	//
	// Deprecated: Do not use.
	LotteryRequest *LotteryRequest `protobuf:"bytes,8,opt,name=lottery_request,json=lotteryRequest,proto3,netof"`
}
...
type Response_LotteryResponse struct {
	// Deprecated: Do not use.
	LotteryResponse *LotteryResponse `protobuf:"bytes,3,opt,name=lottery_response,json=lotteryResponse,proto3,netof"`
}
...
func file_message_proto_init() {
	...
	file_message_proto_msgTypes[0].netofWrappers = []interface{}{
		(*Message_Staking)(nil),
	...
	file_message_proto_msgTypes[1].netofWrappers = []interface{}{
