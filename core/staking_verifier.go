...
const netThousand = 1000

var (
	netAsBigInt           = big.NewInt(denominations.net)
	minimumDelegation     = new(big.Int).Mul(netAsBigInt, big.NewInt(netThousand))
	errDelegationTooSmall = errors.New("minimum delegation amount for a delegator has to be greater than or equal to 1000 net")
)
