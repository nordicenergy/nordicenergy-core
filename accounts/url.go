...
// are considered features here) that it contains value-copyable compnetnts only,
...
// net single canonical form opposed to many allowed nets by the RFC 3986 spec.
//
