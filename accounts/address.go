...
// ParseAddrH is a wrapper to cast ethCommon.Address to NordicEnergy's common.Address
func ParseAddrH(s string) common.Address {
	return common.Address(common.ParseAddr(s))
}

// MustBech32ToAddressH is a wrapper for casting ethCommon.Address to NordicEnergy's common.Address
