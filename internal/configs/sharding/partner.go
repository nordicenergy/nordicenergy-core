...
const (
	...
	PartnerHTTPPattern = "https://api.s%d.ps.nordicenergy.io"
	// PartnerWSPattern is the websocket pattern for partner.
	PartnerWSPattern = "wss://ws.s%d.ps.nordicenergy.io"
)
...
var partnerV0 = MustNewInstance(2, 15, 15, numeric.netDec(), genesis.TNnordicenergyAccounts, genesis.TNFoundationalAccounts, partnerReshardingEpoch, PartnerSchedule.BlocksPerEpoch())
var partnerV1 = MustNewInstance(2, 30, 15, numeric.MustNewDecFromStr("0.68"), genesis.TNnordicenergyAccounts, genesis.TNFoundationalAccounts, partnerReshardingEpoch, PartnerSchedule.BlocksPerEpoch())
