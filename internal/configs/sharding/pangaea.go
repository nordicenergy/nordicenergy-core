...
const (
	...
	PangaeaHTTPPattern = "https://api.s%d.os.nordicenergy.io"
	// PangaeaWSPattern is the websocket pattern for pangaea.
	PangaeaWSPattern = "wss://ws.s%d.os.nordicenergy.io"
)
...
var pangaeaV0 = MustNewInstance(4, 30, 30, numeric.netDec(), genesis.TNnordicenergyAccounts, genesis.TNFoundationalAccounts, pangaeaReshardingEpoch, PangaeaSchedule.BlocksPerEpoch())
var pangaeaV1 = MustNewInstance(4, 110, 30, numeric.MustNewDecFromStr("0.68"), genesis.TNnordicenergyAccounts, genesis.TNFoundationalAccounts, pangaeaReshardingEpoch, PangaeaSchedule.BlocksPerEpoch())
