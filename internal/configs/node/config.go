...
// NetworkType describes the type of nordicenergy network
...
type ConfigType struct {
	// The three groupID design, please refer to https://github.com/nordicenergy/nordicenergy-core/blob/master/node/node.md#libp2p-integration
...
// It has at least net configuration.
// The first net is the default, global node configuration
