...
import (
	...
	"github.com/nordicenergy/nordicenergy-core/internal/bech32"
...
// Address represents the 20 byte address of an nordicenergy account.
...
// nordicenergy address or not.
func IsBech32Address(s string) bool {
	hrp, bytes, err := bech32.DecodeAndConvert(s)
	if err != nil || (hrp != "net" && hrp != "tnet") || len(bytes) != AddressLength {
		return false
	}
	return true
}
...
// Bech32AddressHRP is the human-readable part of the nordicenergy address used by
// this process.
var Bech32AddressHRP = "net"
