...
func TestIsBech32Address(t *testing.T) {
	tests := []struct {
		...
		{"net1ay37rp2pc3kjarg7a322vu3sa8j9puahg679z3", true},
		{"net1fdv7u7rll9epgcqv9xxh9lhwq427nsqldp8ua9", true},
		{"tnet1fdv7u7rll9epgcqv9xxh9lhwq427nsqlr5wca5", true},
		{"tnet1fdv7u7rll9epgcqv9xxh9lhwq427nsqlr5wca1", false},
		{"xnet1fdv7u7rll9epgcqv9xxh9lhwq427nsqlr5wca5", false},
		{"ne1fdv7u7rll9epgcqv9xxh9lhwq427nsqlr5wca5", false},
		{"1net1fdv7u7rll9epgcqv9xxh9lhwq427nsqlr5wca5", false},
		{"net2fdv7u7rll9epgcqv9xxh9lhwq427nsqlr5wca5", false},
	}
...
func TestAddressUnmarshalJSON(t *testing.T) {
	...
	for i, test := range tests {
		...
		if err == nil {
			if test.ShouldErr {
				t.Errorf("test #%d: expected error, got nnet", i)
			}
...
func TestAddressToBech32(t *testing.T) {
	...
	if address, err := AddressToBech32(adr); err == nil {
		if address != "net1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur" {
...
func TestParseAddr(t *testing.T) {
	adr := ethCommon.HexToAddress("0x15a128e599b74842bccba860311efa92991bffb5")
	adr2 := ParseAddr("net1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur")
	if adr.Hex() != adr2.Hex() {
		t.Errorf("error on ParseAddr")
	}
	// Parsing incorrect address
	adr3 := ParseAddr("helloworldnet1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ufdfsrfasdfadfas")
