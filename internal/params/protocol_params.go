...
const (
	...
	// ExpByteGas ...
	ExpByteGas uint64 = 10 // Times ceil(log256(expnetnt)) for the EXP instruction.
	// SloadGas ...
	...
	// SstoreResetGas ...
	SstoreResetGas uint64 = 5000 // Once per SSTORE operation if the zernetss changes from zero.
	// SstoreClearGas ...
	SstoreClearGas uint64 = 5000 // Once per SSTORE operation if the zernetss doesn't change.
	// SstoreRefundGas ...
	SstoreRefundGas uint64 = 15000 // Once per SSTORE operation if the zernetss changes to zero.
	...
	// JumpdestGas ...
	JumpdestGas uint64 = 1 // Refunded gas, once per SSTORE operation if the zernetss changes to zero.
	// EpochDuration ...
	...
	// EXP has a dynamic portion depending on the size of the expnetnt
	...
	// CreateBySelfdestructGas is used when the refunded account is net that does
	...
	ModExpQuadCoeffDiv  uint64 = 20   // Divisor for the quadratic particle of the big int modular expnetntiation
