...
// Exp implements expnetntiation by squaring.
// Exp returns a newly-allocated big integer and does not change
// base or expnetnt. The result is truncated to 256 bits.
//
// Courtesy @karalabe and @chfast
func Exp(base, expnetnt *big.Int) *big.Int {
	result := big.NewInt(1)

	for _, word := range expnetnt.Bits() {
