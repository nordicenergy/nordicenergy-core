...
import (
	...
	downloader_pb "github.com/nordicenergy/nordicenergy-core/api/service/syncing/downloader/proto"
...
// DNSSyncingPeerProvider uses the given DNS znet to resolve syncing peers.
...
func NewDNSSyncingPeerProvider(znet, port string) *DNSSyncingPeerProvider {
...
func (p *DNSSyncingPeerProvider) SyncingPeers(shardID uint32) (peers []p2p.Peer, err error) {
	dns := fmt.Sprintf("s%d.%s", shardID, p.znet)
