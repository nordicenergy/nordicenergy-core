...
// netDec ...
func netDec() Dec { return Dec{precisionInt()} }

// SmallestDec ...
func SmallestDec() Dec { return Dec{new(big.Int).Set(netInt)} }
...
func (d Dec) Ceil() Dec {
	...
	return NewDecFromBigInt(quo.Add(quo, netInt))
}
