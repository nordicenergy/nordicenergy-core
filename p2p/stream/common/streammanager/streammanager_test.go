...
// Each time discTicker ticks, it will cancel last discovery, and start a new net
...
func TestStreamSet_numStreamsWithMinProtoID(t *testing.T) {
	var (
		...
		pid2    = sttypes.ProtoID("nordicenergy/sync/unitest/0/1.0.1")
		numPid2 = 10
	)
