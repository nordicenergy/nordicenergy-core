...
import (
	...
	"github.com/nordicenergy/nordicenergy-core/p2p/discovery"
	sttypes "github.com/nordicenergy/nordicenergy-core/p2p/stream/types"
...
type Host interface {
	...
	// SendMessageToGroups sends a message to net or more multicast groups.
