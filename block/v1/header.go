...
//
// This field is a remnant from Ethereum, and nordicenergy does not use it and always
// zeroes it out.
...
//
// It normally increases by net for each subsequent block, or by more than net
// if net or more PBFT/FBFT view changes have occurred.
//
// The returned instance is a copy; the caller may do anything with it.
