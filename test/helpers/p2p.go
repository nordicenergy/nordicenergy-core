...
import (
	"github.com/nordicenergy/bls/ffi/go/bls"
...
func init() {
	...
	Topics = []string{
		"ngy/testnet/0.0.1/client/beacon",
		"ngy/testnet/0.0.1/node/beacon",
		"ngy/testnet/0.0.1/node/shard/1",
		"ngy/testnet/0.0.1/node/shard/2",
		"ngy/testnet/0.0.1/node/shard/3",
	}
...
func GeneratePeer(address string, port string) (p2p.Peer, error) {
	peerPrivateKey := nordicenergy_bls.RandPrivateKey()
