...
import (
	...
	core_state "github.com/nordicenergy/nordicenergy-core/core/state"
	...
	pkgworker "github.com/nordicenergy/nordicenergy-core/node/worker"
)
...
func fundFaucetContract(chain *core.BlockChain) {
	...
	fmt.Println()
	fmt.Println("--------- Funding addresses for Faucet Contract Call Dnet ---------")
}
...
func callFaucetContractToFundAnAddress(chain *core.BlockChain) {
	...
	fmt.Println(state.GetBalance(allRandomUserAddress[0]))
	fmt.Println()
	fmt.Println("--------- Faucet Contract Call Dnet ---------")
}
...
func main() {
	...
	txpool := core.NewTxPool(core.DefaultTxPoolConfig, chainConfig, chain, types.NewTransactinetrrorSink())
