...
func TestConstructPlainTransaction(t *testing.T) {
	...
	refCompnetnts := &OperationCompnetnts{
	...
	generalTx, rosettaError := constructPlainTransaction(refCompnetnts, refMetadata, refShard)
	if rosettaError != nil {
		t.Fatal(rosettaError)
	}
	tx, ok := generalTx.(*ngyTypes.Transaction)
	if !ok {
	...
	if tx.Value().Cmp(refCompnetnts.Amount) != 0 {
	...
	_, rosettaError = constructPlainTransaction(&OperationCompnetnts{
		Type:           common.NativeTransferOperation,
		From:           refFrom,
		To:             nil,
		Amount:         big.NewInt(12000),
	...
	_, rosettaError = constructPlainTransaction(refCompnetnts, &ConstructMetadata{
		Transaction: &TransactionMetadata{
			Data: &badData,
		},
		Nonce:    0,
...
func TestConstructCrossShardTransaction(t *testing.T) {
	...
	// test valid transaction
	generalTx, rosettaError := constructCrossShardTransaction(refCompnetnts, refMetadata, refShard)
	if rosettaError != nil {
		t.Fatal(rosettaError)
	}
	tx, ok := generalTx.(*ngyTypes.Transaction)
	...
	// test invalid receiver
	_, rosettaError = constructCrossShardTransaction(&OperationCompnetnts{
		Type:           common.NativeCrossShardTransferOperation,
		From:           refFrom,
		To:             nil,
		Amount:         big.NewInt(12000),
	...
	// test invalid data
	badData := "this is not a hex string"
	_, rosettaError = constructCrossShardTransaction(refCompnetnts, &ConstructMetadata{
		Transaction: &TransactionMetadata{
			Data:        &badData,
			FromShardID: &refShard,
			ToShardID:   &refToShard,
...
func TestConstructContractCreationTransaction(t *testing.T) {
	...
	// test valid transaction
	generalTx, rosettaError := constructContractCreationTransaction(refCompnetnts, refMetadata, refShard)
	if rosettaError != nil {
		t.Fatal(rosettaError)
	}
	tx, ok := generalTx.(*ngyTypes.Transaction)
	...
	// test invalid data
	badData := "this is not a hex string"
	_, rosettaError = constructContractCreationTransaction(refCompnetnts, &ConstructMetadata{
		Transaction: &TransactionMetadata{
			Data: &badData,
		},
		Nonce:    0,
...
func TestConstructTransaction(t *testing.T) {
	...
	generalTx, rosettaError := ConstructTransaction(&OperationCompnetnts{
		Type:           common.NativeCrossShardTransferOperation,
		From:           refFrom,
		To:             refTo,
		Amount:         big.NewInt(12000),
	...
	_, rosettaError = ConstructTransaction(&OperationCompnetnts{
		Type:           common.NativeTransferOperation,
		From:           refFrom,
		To:             refTo,
		Amount:         big.NewInt(12000),
