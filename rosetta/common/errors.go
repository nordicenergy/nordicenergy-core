...
var (
	...
	// TransactionSubmissinetrror ..
	TransactionSubmissinetrror = types.Error{
		Code:      3,
		Message:   "transaction submission error",
		Retriable: true,
	}

	// StakingTransactionSubmissinetrror ..
	StakingTransactionSubmissinetrror = types.Error{
		Code:      4,
	...
	// InvalidTransactionConstructinetrror ..
	InvalidTransactionConstructinetrror = types.Error{
		Code:      9,
